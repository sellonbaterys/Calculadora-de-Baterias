...
const ReportDisplay: React.FC<ReportDisplayProps> = ({ content, projectData, results }) => {
    ...
    return (
        <div className="mt-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
            ...
            {/* --- DOCUMENTO A4 (Adicionado ID para isolamento) --- */}
            <div id="printable-area" className="bg-white w-full max-w-[210mm] min-h-[297mm] mx-auto shadow-2xl overflow-hidden print:shadow-none print:m-0 print:max-w-none relative flex flex-col font-sans text-slate-800">
            ...
            <style>{`
                @media print {
                    ...
                    /* Torna visível APENAS a área do relatório (id="printable-area") */
                    #printable-area, #printable-area * {
                        visibility: visible;
                    }

                    /* Posiciona o relatório no topo absoluto para ocupar a folha */
                    #printable-area {
                        position: absolute;
                        left: 0;
                        top: 0;
                    ...
                    /* Garante cores exatas (backgrounds, bordas, gráficos) */
                    * { 
                        -webkit-print-color-adjust: exact !important; 
                        print-color-adjust: exact !important; 
                    }
                    
                    /* Ajustes específicos para cabeçalho */
